...
export const mockProveedores: Proveedor[] = [
  {
    ...
    sitioWeb: 'https://floresdelvalle.mx',
    descripcion: 'Especialistas en arreglos florales con flores silvestres y técnicas de diseño floral artístico.',
    servicios: ['Altar nupcial', 'Centros de mesa', 'Arco floral', 'Bouquet de novia', 'Decoración de acceso'],
    precioBase: 35000,
    precioMin: 20000,
    precioMax: 80000,
    calificacion: 5,
  ...
  },
  {
    ...
    contacto: 'Rodrigo Herrera',
    email: 'hola@lenteyalma.com',
    telefono: '+52 55 4444 5555',
    whatsapp: '+52 55 4444 5556',
    sitioWeb: 'https://lenteyalma.com',
    descripcion: 'Fotografía documental de bodas con estilo editorial. Capturamos emociones auténticas.',
    servicios: ['Fotografía de ceremonia', 'Fotografía de recepción', 'Sesión de preparativos', 'Álbum impreso', 'Galería digital'],
    precioBase: 45000,
    precioMin: 35000,
    precioMax: 75000,
    calificacion: 5,
  ...
  },
  {
    ...
    categoria: 'catering',
    contacto: 'Fernanda Quiroz',
    email: 'eventos@gourmetevents.mx',
    telefono: '+52 55 6666 7777',
    whatsapp: '+52 55 6666 7777',
    sitioWeb: 'https://gourmetevents.mx',
    descripcion: 'Catering premium para eventos sociales. Menús diseñados por chefs con más de 15 años de experiencia.',
    servicios: ['Menú de 3 tiempos', 'Buffet', 'Barra de cócteles', 'Mesa de postres', 'Vajilla y meseros'],
    precioBase: 850,
    precioMin: 600,
    precioMax: 1500,
    calificacion: 4,
  ...
  },
  {
    ...
    whatsapp: '+52 55 8888 9998',
    descripcion: 'Orquesta de 8 músicos con repertorio clásico, jazz y boleros. Más de 200 bodas realizadas.',
    servicios: ['Ceremonia religiosa', 'Cóctel', 'Recepción', 'Primer vals', 'Musicalización completa'],
    precioBase: 28000,
    precioMin: 22000,
    precioMax: 45000,
    calificacion: 4,
  ...
  },
  {
    ...
    sitioWeb: 'https://ambiancedeco.mx',
    descripcion: 'Diseño integral de espacios para bodas. Creamos ambientes únicos que reflejan tu personalidad.',
    servicios: ['Diseño de altar', 'Centros de mesa', 'Iluminación arquitectónica', 'Entrada y acceso', 'Coordinación de montaje'],
    precioBase: 55000,
    precioMin: 40000,
    precioMax: 120000,
    calificacion: 5,
  ...
  {
    id: 'proveedor-6',
    nombre: 'Hacienda San Carlos',
    categoria: 'venue',
    contacto: 'Roberto Salinas',
    email: 'eventos@haciendasancarlos.mx',
    telefono: '+52 55 3333 4444',
    whatsapp: '+52 55 3333 4445',
    sitioWeb: 'https://haciendasancarlos.mx',
    descripcion: 'Hacienda del siglo XVIII con jardines, capilla y salón de 500 m². El venue perfecto para bodas de lujo.',
    servicios: ['Renta de jardín', 'Salón principal', 'Capilla colonial', 'Área de cóctel', 'Estacionamiento privado'],
    precioBase: 115000,
    precioMin: 85000,
    precioMax: 200000,
    calificacion: 5,
    creadoEn: '2023-11-05T00:00:00.000Z',
  },
  {
    id: 'proveedor-7',
    nombre: 'Bella Vista Video',
    categoria: 'video',
    contacto: 'Miguel Sandoval',
    email: 'proyectos@bellavistav.mx',
    telefono: '+52 55 5555 6666',
    whatsapp: '+52 55 5555 6666',
    descripcion: 'Producción cinematográfica de bodas. Video en 4K con dron, steadicam y equipo de última generación.',
    servicios: ['Video de ceremonia', 'Video de recepción', 'Película de bodas (15 min)', 'Reels para redes', 'Toma aérea con dron'],
    precioBase: 32000,
    precioMin: 25000,
    precioMax: 60000,
    calificacion: 4,
    creadoEn: '2024-02-14T00:00:00.000Z',
  },
  {
    id: 'proveedor-8',
    nombre: 'Sweet Moments Pastelería',
    categoria: 'pasteleria',
    contacto: 'Ana Lim',
    email: 'pedidos@sweetmoments.mx',
    telefono: '+52 55 7777 8888',
    whatsapp: '+52 55 7777 8888',
    sitioWeb: 'https://sweetmoments.mx',
    descripcion: 'Pasteles artísticos para bodas. Diseños personalizados con ingredientes premium y técnicas europeas.',
    servicios: ['Pastel de bodas', 'Naked cake', 'Cupcakes personalizados', 'Mesa de dulces', 'Degustación previa'],
    precioBase: 8500,
    precioMin: 5000,
    precioMax: 25000,
    calificacion: 5,
    creadoEn: '2024-04-03T00:00:00.000Z',
  },
]
...
export const mockTareas: Tarea[] = [
  // CONTRATACIÓN (3)
  { id: 'tarea-1', eventoId: 'evento-1', titulo: 'Enviar contrato a Lente & Alma',
    fase: 'Contratación', responsable: 'Andrea Morales',
    fechaInicio: '2026-04-13T00:00:00.000Z', fechaVencimiento: '2026-04-20T00:00:00.000Z',
    estado: 'pendiente', orden: 1 },
  { id: 'tarea-2', eventoId: 'evento-1', titulo: 'Firmar contrato con Hacienda San Carlos',
    fase: 'Contratación', responsable: 'Andrea Morales',
    fechaInicio: '2026-04-13T00:00:00.000Z', fechaVencimiento: '2026-04-25T00:00:00.000Z',
    estado: 'completada', orden: 2 },
  { id: 'tarea-3', eventoId: 'evento-1', titulo: 'Contratar DJ para after party',
    fase: 'Contratación', responsable: 'Luisa Pérez',
    fechaInicio: '2026-05-01T00:00:00.000Z', fechaVencimiento: '2026-05-15T00:00:00.000Z',
    estado: 'pendiente', orden: 3 },
  // DISEÑO (2)
  { id: 'tarea-4', eventoId: 'evento-1', titulo: 'Definir paleta de colores final',
    fase: 'Diseño', responsable: 'Andrea Morales',
    fechaInicio: '2026-04-13T00:00:00.000Z', fechaVencimiento: '2026-04-30T00:00:00.000Z',
    estado: 'completada', orden: 4 },
  { id: 'tarea-5', eventoId: 'evento-1', titulo: 'Aprobar maqueta de invitaciones',
    fase: 'Diseño', responsable: 'Andrea Morales',
    fechaInicio: '2026-04-25T00:00:00.000Z', fechaVencimiento: '2026-05-10T00:00:00.000Z',
    estado: 'en_progreso', orden: 5 },
  // LOGÍSTICA (3)
  { id: 'tarea-6', eventoId: 'evento-1', titulo: 'Confirmar menú final con catering',
    fase: 'Logística', responsable: 'Andrea Morales',
    fechaInicio: '2026-04-20T00:00:00.000Z', fechaVencimiento: '2026-04-30T00:00:00.000Z',
    estado: 'en_progreso', orden: 6 },
  { id: 'tarea-7', eventoId: 'evento-1', titulo: 'Visita técnica al venue',
    fase: 'Logística', responsable: 'Andrea Morales',
    fechaInicio: '2026-04-28T00:00:00.000Z', fechaVencimiento: '2026-05-01T00:00:00.000Z',
    estado: 'completada', orden: 7 },
  { id: 'tarea-8', eventoId: 'evento-1', titulo: 'Coordinar transporte de invitados',
    fase: 'Logística', responsable: 'Miguel Rodríguez',
    fechaInicio: '2026-05-15T00:00:00.000Z', fechaVencimiento: '2026-06-01T00:00:00.000Z',
    estado: 'pendiente', orden: 8 },
  // COMUNICACIÓN (2)
  { id: 'tarea-9', eventoId: 'evento-1', titulo: 'Enviar save-the-date digital',
    fase: 'Comunicación', responsable: 'Andrea Morales',
    fechaInicio: '2026-04-13T00:00:00.000Z', fechaVencimiento: '2026-04-18T00:00:00.000Z',
    estado: 'atrasada', orden: 9 },
  { id: 'tarea-10', eventoId: 'evento-1', titulo: 'Confirmar dietary requirements con invitados',
    fase: 'Comunicación', responsable: 'Luisa Pérez',
    fechaInicio: '2026-05-10T00:00:00.000Z', fechaVencimiento: '2026-05-25T00:00:00.000Z',
    estado: 'pendiente', orden: 10 },
  // DÍA DEL EVENTO (2)
  { id: 'tarea-11', eventoId: 'evento-1', titulo: 'Prueba de vestido de novia',
    fase: 'Día del evento', responsable: 'Valentina García',
    fechaInicio: '2026-05-12T00:00:00.000Z', fechaVencimiento: '2026-05-15T00:00:00.000Z',
    estado: 'pendiente', orden: 11 },
  { id: 'tarea-12', eventoId: 'evento-1', titulo: 'Coordinación general día del evento',
    fase: 'Día del evento', responsable: 'Andrea Morales',
    fechaInicio: '2026-06-14T00:00:00.000Z', fechaVencimiento: '2026-06-15T00:00:00.000Z',
    estado: 'pendiente', orden: 12 },
  // POST-EVENTO (1)
  { id: 'tarea-13', eventoId: 'evento-1', titulo: 'Entrega de galería fotográfica',
    fase: 'Post-evento', responsable: 'Andrea Morales',
    fechaInicio: '2026-07-01T00:00:00.000Z', fechaVencimiento: '2026-07-15T00:00:00.000Z',
    estado: 'pendiente', orden: 13 },
]
...
export const mockContratos: Contrato[] = [
  ...
  },
  {
    ...
    eventoId: 'evento-2',
    tipo: 'cliente',
    contraparte: 'Carmen Martínez',
    contraparteId: 'cliente-2',
    estado: 'enviado',
    montoTotal: 45000,
    fechaCreacion: '2025-11-20T00:00:00.000Z',
    fechaEnvio: '2025-11-21T00:00:00.000Z',
    version: 1,
  },
  {
    id: 'contrato-5',
    eventoId: 'evento-2',
    tipo: 'proveedor',
    contraparte: 'Gourmet Events Catering',
    contraparteId: 'proveedor-3',
    estado: 'firmado',
    montoTotal: 48000,
    fechaCreacion: '2025-12-01T00:00:00.000Z',
    fechaEnvio: '2025-12-02T00:00:00.000Z',
    fechaFirma: '2025-12-05T00:00:00.000Z',
    version: 1,
  },
  {
    id: 'contrato-6',
    eventoId: 'evento-3',
    tipo: 'cliente',
    contraparte: 'Isabella Hernández',
    contraparteId: 'cliente-3',
    estado: 'borrador',
    montoTotal: 200000,
...
export const mockODPs: ODP[] = [
  ...
  },
  {
    ...
    descripcion: 'Decoración integral — Boda García-Rodríguez',
    monto: 65000,
    fecha: '2026-06-15T00:00:00.000Z',
    estado: 'confirmada',
    requerimientos: 'Tema: garden chic. Altar con arco de flores, 20 centros de mesa con candelabros, iluminación perimetral en jardín.',
  },
  {
    id: 'odp-4',
    eventoId: 'evento-1',
    proveedorId: 'proveedor-4',
    descripcion: 'Orquesta para ceremonia y cóctel — Boda García-Rodríguez',
    monto: 28000,
    fecha: '2026-06-15T00:00:00.000Z',
    estado: 'pendiente',
    requerimientos: 'Ceremonia: Ave María + marcha nupcial. Cóctel: repertorio jazz 3 horas. Equipo de sonido propio.',
  },
  {
    id: 'odp-5',
    eventoId: 'evento-2',
    proveedorId: 'proveedor-3',
    descripcion: 'Catering para XV años — Cumpleaños Torres',
    monto: 48000,
    fecha: '2026-08-20T00:00:00.000Z',
    estado: 'confirmada',
    requerimientos: 'Menú de 3 tiempos para 80 personas. Barra de refrescos y agua de sabor. Vajilla incluida.',
  },
]
